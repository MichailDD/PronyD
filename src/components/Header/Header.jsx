        ...
        <header>
            ...
            <div className={s.header__blok}>
                ...
                <div className={s.header__right}>
                  ...
                  {/* <input className={s.input} checked type="radio" name="theme"  /><span className={s.theme__title}>{headerState[1].text1}</span>
                   <input   className={s.input} type="radio" name="theme"  /><span className={s.theme__title}>{headerState[1].text2}</span> */}
                  <label className={s.label}> 
                  <input checked type="radio" name="name1"className={s.input}  />
                  ...
                  <div className={s.person}>
                    ...
                    <div className={s.info__avatar}>
                        <div className={s.avatar__title}><MenuTitle menu__title={headerState[1].text3}/></div>
