...
const Registration = () => {
  ...
  return (
    <div className={`${s.changePassword} container`}>
      <p className={s.changePasswordTitle}>User registration</p>
      <div className={s.form}>
        <div className={s.formInputWr}>
          <p className={s.formInputText}>Your name</p>
          <input className={s.formInput} placeholder="Enter your name" />
        </div>
        <div className={s.formInputWr}>
          <p className={s.formInputText}>Your last name</p>
